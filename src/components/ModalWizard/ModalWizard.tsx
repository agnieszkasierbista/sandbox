...
import {
    StyledCustomizableModal as StyledModalWizard,
    StyledFieldset,
    StyledFormForWizard,
    StyledRange,
    StyledSectionBlurs,
...
import {FormFieldNameAndValueArray} from "../App/App.types";
                ...
                <StyledFieldset id="modalCustomizer">
                    ...
                    <section>
                        ...
                        <input
                            ...
                            value="blured"
                            id="blured"
                            onChange={() => setIsHidden((prev) => {
                                return {...prev, blur: !prev.blur}
                            })}/>
                    ...
                    <StyledSectionBlurs id="blurs" isHidden={isHidden.blur}>
                        ...
                        <input
                            ...
                            id="manual"
                            onChange={() => setIsHidden((prev) => {
                                return {...prev, manual: !prev.manual}
                            })}
                        />
